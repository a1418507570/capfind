...
短期优先级是收敛 v0.1：Java 行号、路径解析、过滤语义、`explain`、`.capfindignore`、`.capfind/config.toml` 搜索参数、CLI 主流程集成测试、GitHub Actions CI、基础发布打包脚本、多平台 Release 工作流已进入第一轮实现；下一步继续补齐安装脚本与首个版本发布。
